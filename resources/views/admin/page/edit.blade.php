    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-6">
        <div class="card shadow mb-4">
          ...
          <!-- Card Body -->
          <div class="card-body">
            <form id="form-product" method="post" action="{{route('page.update', $page->id_page)}}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title_eng" name="title_en" value="{{$page->title_en}}" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group mt-2">
                    ...
                    <textarea id="content" class="summernote" name="content_en" >{{$page->content_en}}</textarea>
                </div>
                <div class="form-group">
